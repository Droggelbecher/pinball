...
enum PNG_LIBPNG_VER_STRING = "1.6.34";
enum PNG_HEADER_VERSION_STRING = " libpng version 1.6.34 - September 29, 2017\n";
...
enum PNG_LIBPNG_VER_RELEASE = 34;
 ...
 */
enum PNG_LIBPNG_VER = 10634; /* 1.6.34 */
 ...
 */
alias png_libpng_version_1_6_34 = char*;
...
alias png_const_structp = const(png_struct_def)*;
alias png_structp = png_struct_def*;
alias png_structpp = png_struct_def**;
 ...
 */
struct png_info_def;
alias png_info = png_info_def;
alias png_infop = png_info_def*;
alias png_const_infop = const(png_info_def)*;
alias png_infopp = png_info_def**;
 ...
 */
alias png_structrp = png_struct_def*;
alias png_const_structrp = const(png_struct_def)*;
alias png_inforp = png_info_def*;
alias png_const_inforp = const(png_info_def)*;
...
alias png_color = png_color_struct;
alias png_colorp = png_color_struct*;
alias png_const_colorp = const(png_color_struct)*;
alias png_colorpp = png_color_struct**;
...
alias png_color_16 = png_color_16_struct;
alias png_color_16p = png_color_16_struct*;
alias png_const_color_16p = const(png_color_16_struct)*;
alias png_color_16pp = png_color_16_struct**;
...
alias png_color_8 = png_color_8_struct;
alias png_color_8p = png_color_8_struct*;
alias png_const_color_8p = const(png_color_8_struct)*;
alias png_color_8pp = png_color_8_struct**;
...
alias png_sPLT_entry = png_sPLT_entry_struct;
alias png_sPLT_entryp = png_sPLT_entry_struct*;
alias png_const_sPLT_entryp = const(png_sPLT_entry_struct)*;
alias png_sPLT_entrypp = png_sPLT_entry_struct**;
...
alias png_sPLT_t = png_sPLT_struct;
alias png_sPLT_tp = png_sPLT_struct*;
alias png_const_sPLT_tp = const(png_sPLT_struct)*;
alias png_sPLT_tpp = png_sPLT_struct**;
...
alias png_text = png_text_struct;
alias png_textp = png_text_struct*;
alias png_const_textp = const(png_text_struct)*;
alias png_textpp = png_text_struct**;
...
alias png_time = png_time_struct;
alias png_timep = png_time_struct*;
alias png_const_timep = const(png_time_struct)*;
alias png_timepp = png_time_struct**;
...
alias png_unknown_chunk = png_unknown_chunk_t;

alias png_unknown_chunkp = png_unknown_chunk_t*;
alias png_const_unknown_chunkp = const(png_unknown_chunk_t)*;
alias png_unknown_chunkpp = png_unknown_chunk_t**;
...
alias png_row_info = png_row_info_struct;

alias png_row_infop = png_row_info_struct*;
alias png_row_infopp = png_row_info_struct**;
...
alias png_rw_ptr = void function (png_structp, png_bytep, png_size_t);
 ...
 */
alias png_longjmp_ptr = void function (jmp_buf, int);
...
enum PNG_TRANSFORM_EXPAND_16 = 0x4000; /* read only */ /* else this might break */
 ...
 * following.
 */
alias png_malloc_ptr = void* function (png_structp, png_alloc_size_t);
 ...
 */
extern (D) auto png_check_sig(T0, T1)(auto ref T0 sig, auto ref T1 n)
{
...
extern (D) auto png_jmpbuf(T)(auto ref T png_ptr)
{
...
//int png_convert_to_rfc1123_buffer (char[PNG_EXPORT] out_, png_const_timep ptime);
...
void png_set_scale_16 (png_structrp png_ptr); /* Name prior to 1.5.4 */
...
enum PNG_FILTER_VALUE_LAST = 5; /* DEPRECATED */
...
float png_get_x_offset_inches (png_const_structrp png_ptr, png_const_inforp info_ptr); /* otherwise not implemented. */
png_fixed_point png_get_x_offset_inches_fixed (png_const_structrp png_ptr, png_const_inforp info_ptr);

float png_get_y_offset_inches (png_const_structrp png_ptr, png_const_inforp info_ptr); /* otherwise not implemented. */
 ...
 */
extern (D) auto PNG_PASS_START_ROW(T)(auto ref T pass)
{
    return ((1 & ~pass) << (3 - (pass >> 1))) & 7;
}

extern (D) auto PNG_PASS_START_COL(T)(auto ref T pass)
{
 ...
 */
extern (D) auto PNG_PASS_ROW_OFFSET(T)(auto ref T pass)
{
    return pass > 2 ? (8 >> ((pass - 1) >> 1)) : 8;
}

extern (D) auto PNG_PASS_COL_OFFSET(T)(auto ref T pass)
{
    return 1 << ((7 - pass) >> 1);
}
 ...
 */
extern (D) auto PNG_PASS_ROW_SHIFT(T)(auto ref T pass)
{
    return pass > 2 ? (8 - pass) >> 1 : 3;
}

extern (D) auto PNG_PASS_COL_SHIFT(T)(auto ref T pass)
{
 ...
 */
extern (D) auto PNG_PASS_ROWS(T0, T1)(auto ref T0 height, auto ref T1 pass)
{
    return (height + (((1 << PNG_PASS_ROW_SHIFT(pass)) - 1) - PNG_PASS_START_ROW(pass))) >> PNG_PASS_ROW_SHIFT(pass);
}

extern (D) auto PNG_PASS_COLS(T0, T1)(auto ref T0 width, auto ref T1 pass)
{
    return (width + (((1 << PNG_PASS_COL_SHIFT(pass)) - 1) - PNG_PASS_START_COL(pass))) >> PNG_PASS_COL_SHIFT(pass);
}
 ...
 */
extern (D) auto PNG_ROW_FROM_PASS_ROW(T0, T1)(auto ref T0 y_in, auto ref T1 pass)
{
    return (y_in << PNG_PASS_ROW_SHIFT(pass)) + PNG_PASS_START_ROW(pass);
}

extern (D) auto PNG_COL_FROM_PASS_COL(T0, T1)(auto ref T0 x_in, auto ref T1 pass)
{
 ...
 * the tile.
 */
extern (D) auto PNG_PASS_MASK(T0, T1)(auto ref T0 pass, auto ref T1 off)
{
    return ((0x110145AF >> (((7 - off) - pass) << 2)) & 0xF) | ((0x01145AF0 >> (((7 - off) - pass) << 2)) & 0xF0);
}

extern (D) auto PNG_ROW_IN_INTERLACE_PASS(T0, T1)(auto ref T0 y, auto ref T1 pass)
{
    return (PNG_PASS_MASK(pass, 0) >> (y & 7)) & 1;
}

extern (D) auto PNG_COL_IN_INTERLACE_PASS(T0, T1)(auto ref T0 x, auto ref T1 pass)
{
 ...
 */
extern (D) auto PNG_get_uint_32(T)(auto ref T buf)
{
    return (cast(png_uint_32) *buf << 24) + (cast(png_uint_32) *(buf + 1) << 16) + (cast(png_uint_32) *(buf + 2) << 8) + (cast(png_uint_32) *(buf + 3));
}

/* From libpng-1.4.0 until 1.4.4, the png_get_uint_16 macro (but not the
 * function) incorrectly returned a value of type png_uint_32.
 */
extern (D) auto PNG_get_uint_16(T)(auto ref T buf)
{
    return cast(png_uint_16) (cast(uint) *buf << 8) + (cast(uint) *(buf + 1));
}

extern (D) auto PNG_get_int_32(T)(auto ref T buf)
{
    return cast(png_int_32) (*buf & 0x80) ? -(cast(png_int_32) ((png_get_uint_32(buf) ^ 0xffffffffU) + 1U) & 0x7fffffffU) : cast(png_int_32) png_get_uint_32(buf);
}
...
alias png_get_uint_32 = PNG_get_uint_32;
alias png_get_uint_16 = PNG_get_uint_16;
alias png_get_int_32 = PNG_get_int_32;
...
extern (D) auto PNG_IMAGE_FAILED(T)(auto ref T png_cntrl)
{
 ...
 */
extern (D) auto PNG_IMAGE_SAMPLE_CHANNELS(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_SAMPLE_COMPONENT_SIZE(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_SAMPLE_SIZE(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_MAXIMUM_COLORMAP_COMPONENTS(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_PIXEL_(T0, T1)(auto ref T0 test, auto ref T1 fmt)
{
    return (fmt & PNG_FORMAT_FLAG_COLORMAP) ? 1 : test(fmt);
}

extern (D) auto PNG_IMAGE_PIXEL_CHANNELS(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_PIXEL_COMPONENT_SIZE(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_PIXEL_SIZE(T)(auto ref T fmt)
{
...
extern (D) auto PNG_IMAGE_ROW_STRIDE(T)(auto ref T image)
{
...
extern (D) auto PNG_IMAGE_BUFFER_SIZE(T0, T1)(auto ref T0 image, auto ref T1 row_stride)
{
...
extern (D) auto PNG_IMAGE_SIZE(T)(auto ref T image)
{
...
extern (D) auto PNG_IMAGE_COLORMAP_SIZE(T)(auto ref T image)
{
...
extern (D) auto png_image_write_get_memory_size(T0, T1, T2, T3, T4, T5)(auto ref T0 image, auto ref T1 size, auto ref T2 convert_to_8_bit, auto ref T3 buffer, auto ref T4 row_stride, auto ref T5 colormap)
{
    return png_image_write_to_memory(&image, 0, &size, convert_to_8_bit, buffer, row_stride, colormap);
}
 ...
 */
extern (D) auto PNG_IMAGE_DATA_SIZE(T)(auto ref T image)
{
...
extern (D) auto PNG_ZLIB_MAX_SIZE(T)(auto ref T b)
{
...
extern (D) auto PNG_IMAGE_COMPRESSED_SIZE_MAX(T)(auto ref T image)
{
...
extern (D) auto PNG_IMAGE_PNG_SIZE_MAX(T)(auto ref T image)
{
